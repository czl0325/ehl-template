  ...
  <div class="app-container">
    ...
    <section class="panel my-2 panel-content">
      <div class="panel-table">
        <vxe-table ref="xTable1" :data="tableData" height="100%" :seq-config="{startIndex: ((pagination.pageNumber-1)*pagination.pageCount) }" :loading="pagination.loading" show-overflow>
          ...
          <vxe-column title="操作" width="240" align="center" fixed="right">
            <template #default="{row}">
              <el-button type="primary" size="small" @click="currentUser=row;showUserPermission=true;">修改角色
              </el-button>
      ...
      <vxe-pager v-model:current-page="pagination.pageNumber" v-model:page-size="pagination.pageCount" :total="pagination.total" @page-change="onGetUserList(false)" />
    </section>
